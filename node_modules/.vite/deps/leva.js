import {
  require_prop_types,
  useDrag
} from "./chunk-LKSDAZOU.js";
import {
  require_client,
  require_react_dom
} from "./chunk-26YF6QDO.js";
import {
  require_jsx_runtime
...
function createSlot2(ownerName) {
  ...
  const Slot22 = React16.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
...
function createSlotClone2(ownerName) {
  const SlotClone = React16.forwardRef((props3, forwardedRef) => {
    const { children, ...slotProps } = props3;
    if (React16.isValidElement(children)) {
      ...
      return React16.cloneElement(children, props22);
    }
